...
void clust_from_genomes(int my_rank, int comm_sz, string inputFile, string outputFile, bool is_newick_tree, bool sketchByFile, int kmerSize, int sketchSize, double threshold, string sketchFunc, bool isContainment, int containCompress, int minLen, string folder_path, bool isSave, int threads);
...
void distribute_compute_clusters(int my_rank, int comm_sz, vector<SketchInfo>& sketches, int start_index, int end_index, bool sketchByFile, string outputFile, bool is_newick_tree, string folder_path, int sketch_func_id, double threshold, bool isSave, int threads);
